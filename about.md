...
<section class="mb-5">
  ...
  <div class="row g-0">
    <div class="col-2 text-end timeline-segment pe-4">2023</div>
    <div class="col-10 ps-4 pb-3">
      ...
      <ul>
        ...
        <li>Automated Freelance Platform: <span class="text-muted">evaluated the feasibility of an automated freelancer profile approval system for a Japanese recruitment startup, including dataset analysis and system architecture design.</span></li>
        <li>Improving Recognition Accuracy: <span class="text-muted">closed a 58% accuracy gap for an Australian vendor in their Licence Plate Recognition (LPR) system by merging alternate data sources in real-time.</span></li>
        <li>AI System Audit: <span class="text-muted">performed a full audit of a Hong Kong IoT startup’s legacy AI system for automated climate control. Reviewed internal documentation and source code to make recommendations for improvement and alignment to industry best practices.</span></li>
        <li>Training Workshops: <span class="text-muted">ran multiple <em>AI for Executives</em> courses for C-level executives at different companies, working with them to identify and prioritise AI projects specific to their company.</span></li>
      </ul>
    </div>
  </div>
  <div class="row g-0">
    <div class="col-2 text-end timeline-segment pe-4">2017</div>
    <div class="col-10 ps-4 pb-3">
      <div class="d-sm-flex justify-content-between">
  ...
  <div class="row g-0">
    <div class="col-2 text-end timeline-segment pe-4">2015</div>
    <div class="col-10 ps-4 pb-3">
      <div class="d-sm-flex justify-content-between">
  ...
  <div class="row g-0">
    <div class="col-2 text-end timeline-segment pe-4">2013</div>
...
<section class="mb-5">
  ...
  <div class="row g-0">
    <div class="col-2 text-end timeline-segment pe-4">2007</div>
    <div class="col-10 ps-4 pb-3">
      <div class="d-sm-flex justify-content-between">
  ...
  <div class="row g-0">
    <div class="col-2 text-end timeline-segment pe-4">2003</div>
    <div class="col-10 ps-4">
      <div class="d-sm-flex justify-content-between">
