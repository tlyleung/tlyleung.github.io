...
- **Bilingual Evaluation Understudy Score (BLEU):** measures the overlap between generated text and reference text by comparing n-grams (sequences of words). Used to evaluate the accuracy and fluency of text generated by models in tasks like translation or summarisation.
...
- **Recall-Oriented Understudy for Gisting Evaluation (ROUGE):** measures the overlap between generated text and reference summaries, focusing on recall by comparing n-grams, word sequences, or longest common subsequences. Used in text summarisation tasks to assess how well the generated summary captures the key points of the reference summary.
